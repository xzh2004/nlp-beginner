...
def main():
    ...
    """
    print("=" * 60)
    print("LSTM+CRF Named Entity Recognition Training")
    print("=" * 60)
    ...
    # 保存训练结果
    results_path = os.path.join(config.results_dir, f"training_results_{timestamp}.json")
    final_results = {
        'config': {
            'embedding_dim': config.embedding_dim,
            'hidden_dim': config.hidden_dim,
